...
# alef:hash:8d5a9ea41e87c2b216a60ded87be5b5ef21b64b01a8fb8b3359a625024ea6384
...
defmodule Kreuzberg.Native do
  ...
  def tesseractwasmbackend_name(_obj), do: :erlang.nif_error(:nif_not_loaded)
  def tesseractwasmbackend_version(_obj), do: :erlang.nif_error(:nif_not_loaded)
  def tesseractwasmbackend_initialize(_obj), do: :erlang.nif_error(:nif_not_loaded)
  def tesseractwasmbackend_shutdown(_obj), do: :erlang.nif_error(:nif_not_loaded)
  def tesseractwasmbackend_process_image_async(_obj, _image_bytes, _config), do: :erlang.nif_error(:nif_not_loaded)
  def tesseractwasmbackend_process_image_file_async(_obj, _path, _config), do: :erlang.nif_error(:nif_not_loaded)
  def tesseractwasmbackend_supports_language(_obj, _lang), do: :erlang.nif_error(:nif_not_loaded)
  def tesseractwasmbackend_backend_type(_obj), do: :erlang.nif_error(:nif_not_loaded)
