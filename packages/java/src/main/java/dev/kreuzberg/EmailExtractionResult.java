...
// alef:hash:f32ae9d3e34e8bc6e507a4a535a51bc75b643d5770d15294243b4deb3f7b4b95
...
public record EmailExtractionResult(
    ...
    public static EmailExtractionResult fromJson(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse EmailExtractionResult from JSON", e);
        }
    }
}
