...
// alef:hash:8e3bf8364c5fb26cafd1854fcf1b10fdd73dc5f76de1101ffa7a032c49e4ad18
...
public final class Kreuzberg {
     ...
     *
     *
     * * {@code items} - Vector of BatchFileItem structs, each containing a path and optional per-file configuration
     * overrides. * {@code config} - Batch-level extraction configuration (provides defaults and batch settings)
     *
     *
     ...
     * {@code config}. Pass {@code None} as the config to use the batch-level defaults for that item.
     *
     *
     * * {@code items} - Vector of BatchBytesItem structs, each containing content bytes, MIME type, and optional
     * per-item configuration overrides. * {@code config} - Batch-level extraction configuration
     *
     *
     * A vector of {@code ExtractionResult} in the same order as the input items.
     *
