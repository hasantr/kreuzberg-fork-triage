...
// alef:hash:3a0e2d130012b085ab07f9aca6e959527770fa83456a3fea0781a378ff535d82
...
public record TreeSitterProcessConfig(
    ...
    public static TreeSitterProcessConfig fromJson(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse TreeSitterProcessConfig from JSON", e);
        }
    }
}
