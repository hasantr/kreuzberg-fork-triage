...
/**
 * Allocates Panama FFM upcall stubs for an IDocumentExtractor implementation, assembles the C vtable in native memory,
 * and provides static registerDocumentExtractor/unregisterDocumentExtractor helpers.
 */
public final class DocumentExtractorBridge implements AutoCloseable {
    ...
    private static final ConcurrentHashMap<String, DocumentExtractorBridge> DOCUMENT_EXTRACTOR_BRIDGES = new ConcurrentHashMap<>();
    ...
    DocumentExtractorBridge(final IDocumentExtractor impl) {
        ...
        try {
            ...
            var stubSupportedMimeTypes = LINKER.upcallStub(
                    LOOKUP.bind(this, "handleSupportedMimeTypes",
                            MethodType.methodType(int.class, MemorySegment.class, MemorySegment.class,
                                    MemorySegment.class)),
                    FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
                            ValueLayout.ADDRESS),
            ...
            var stubCanHandle = LINKER.upcallStub(
                    LOOKUP.bind(this, "handleCanHandle",
                            MethodType.methodType(int.class, MemorySegment.class, MemorySegment.class,
                                    MemorySegment.class, MemorySegment.class, MemorySegment.class)),
                    FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
            ...
            var stubAsSyncExtractor = LINKER.upcallStub(
                    LOOKUP.bind(this, "handleAsSyncExtractor",
                            MethodType.methodType(int.class, MemorySegment.class, MemorySegment.class,
                                    MemorySegment.class)),
                    FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
                            ValueLayout.ADDRESS),
    ...
    private int handleExtractBytes(MemorySegment userData, MemorySegment content_in, MemorySegment mime_type_in,
            MemorySegment config_in, MemorySegment outResult, MemorySegment outError) {
        try {
    ...
    private int handleExtractFile(MemorySegment userData, MemorySegment path_in, MemorySegment mime_type_in,
            MemorySegment config_in, MemorySegment outResult, MemorySegment outError) {
        try {
    ...
    private int handleCanHandle(MemorySegment userData, MemorySegment _path_in, MemorySegment _mime_type_in,
    ...
    public static void registerDocumentExtractor(final IDocumentExtractor impl) throws Exception {
        ...
        try {
            try (var nameArena = Arena.ofConfined()) {
                ...
                int rc = (int) NativeLib.KREUZBERG_REGISTER_DOCUMENT_EXTRACTOR.invoke(nameCs, bridge.vtableSegment(),
