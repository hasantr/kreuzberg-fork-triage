...
// alef:hash:7ca40dc97e7a89a655c11a8117ef722f2dbb28d7bafc42370b695bce664d8a80
...
final class NativeLib {
    ...
    static final MethodHandle KREUZBERG_HWPX_EXTRACTOR_NAME = LINKER.downcallHandle(
            LIB.find("kreuzberg_hwpx_extractor_name").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_HWPX_EXTRACTOR_VERSION = LINKER.downcallHandle(
            LIB.find("kreuzberg_hwpx_extractor_version").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_HWPX_EXTRACTOR_INITIALIZE = LINKER.downcallHandle(
            LIB.find("kreuzberg_hwpx_extractor_initialize").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_HWPX_EXTRACTOR_SHUTDOWN = LINKER.downcallHandle(
            LIB.find("kreuzberg_hwpx_extractor_shutdown").orElseThrow(),
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_HWPX_EXTRACTOR_DESCRIPTION = LINKER.downcallHandle(
            LIB.find("kreuzberg_hwpx_extractor_description").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_HWPX_EXTRACTOR_AUTHOR = LINKER.downcallHandle(
            LIB.find("kreuzberg_hwpx_extractor_author").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_HWPX_EXTRACTOR_EXTRACT_BYTES = LINKER.downcallHandle(
            LIB.find("kreuzberg_hwpx_extractor_extract_bytes").orElseThrow(), FunctionDescriptor.of(ValueLayout.ADDRESS,
                    ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_HWPX_EXTRACTOR_SUPPORTED_MIME_TYPES = LINKER.downcallHandle(
            LIB.find("kreuzberg_hwpx_extractor_supported_mime_types").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_HWPX_EXTRACTOR_PRIORITY = LINKER.downcallHandle(
            LIB.find("kreuzberg_hwpx_extractor_priority").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_TESSDATA_MANAGER_CACHE_DIR = LINKER.downcallHandle(
            LIB.find("kreuzberg_tessdata_manager_cache_dir").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_TESSDATA_MANAGER_IS_LANGUAGE_CACHED = LINKER.downcallHandle(
            LIB.find("kreuzberg_tessdata_manager_is_language_cached").orElseThrow(),
            FunctionDescriptor.of(ValueLayout.JAVA_BOOLEAN, ValueLayout.ADDRESS, ValueLayout.ADDRESS));

    static final MethodHandle KREUZBERG_TESSDATA_MANAGER_ENSURE_ALL_LANGUAGES = LINKER.downcallHandle(
            LIB.find("kreuzberg_tessdata_manager_ensure_all_languages").orElseThrow(),
    ...
    static final MethodHandle KREUZBERG_HWPX_EXTRACTOR_FREE = LINKER.downcallHandle(
            LIB.find("kreuzberg_hwpx_extractor_free").orElseThrow(), FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
    ...
    static final MethodHandle KREUZBERG_CLEAR_OCR_BACKEND = LIB.find("kreuzberg_clear_ocr_backend")
    ...
    static final MethodHandle KREUZBERG_CLEAR_POST_PROCESSOR = LIB.find("kreuzberg_clear_post_processor")
            .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)))
            .orElse(null);
    ...
    static final MethodHandle KREUZBERG_CLEAR_VALIDATOR = LIB.find("kreuzberg_clear_validator")
            .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)))
            .orElse(null);
    ...
    static final MethodHandle KREUZBERG_CLEAR_EMBEDDING_BACKEND = LIB.find("kreuzberg_clear_embedding_backend")
            .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)))
            .orElse(null);

    static final MethodHandle KREUZBERG_REGISTER_DOCUMENT_EXTRACTOR = LIB
            .find("kreuzberg_register_document_extractor").map(
                    s -> LINKER
                            .downcallHandle(s,
                                    FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS,
                                            ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
    ...
    static final MethodHandle KREUZBERG_CLEAR_DOCUMENT_EXTRACTOR = LIB.find("kreuzberg_clear_document_extractor")
            .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)))
            .orElse(null);

    static final MethodHandle KREUZBERG_REGISTER_RENDERER = LIB
            .find("kreuzberg_register_renderer").map(
                    s -> LINKER
                            .downcallHandle(s,
                                    FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS,
                                            ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
    ...
    static final MethodHandle KREUZBERG_UNREGISTER_RENDERER = LIB.find("kreuzberg_unregister_renderer")
            .map(s -> LINKER.downcallHandle(s,
                    FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
            .orElse(null);

    static final MethodHandle KREUZBERG_CLEAR_RENDERER = LIB.find("kreuzberg_clear_renderer")
            .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)))
            .orElse(null);
