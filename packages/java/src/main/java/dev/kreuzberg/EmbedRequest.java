...
// alef:hash:3f58d04956c0fc3ac920f411204a906a4eaec61ce2a0ef9ab8d57e521e5fa7b0
...
public record EmbedRequest(@JsonInclude(JsonInclude.Include.NON_NULL) List<String> texts,
     ...
     */
    public static EmbedRequest fromJson(String json) throws KreuzbergRsException {
        try {
            ...
            throw new KreuzbergRsException("Failed to parse EmbedRequest from JSON: " + e.getMessage(), e);
        }
    }
}
