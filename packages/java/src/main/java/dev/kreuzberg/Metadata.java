...
// alef:hash:3dc3c66c0478970a51116fbbbe849865cc01c0afcccb7de9a221415a2b25dd98
...
public record Metadata(@Nullable String title, @Nullable String subject, @Nullable List<String> authors,
        ...
        @Nullable @JsonProperty("output_format") String outputFormat, @JsonProperty("ocr_used") boolean ocrUsed,
