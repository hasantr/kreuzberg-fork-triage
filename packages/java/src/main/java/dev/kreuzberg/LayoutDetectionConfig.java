...
// alef:hash:c143960a258c95121903f6fb3630e563291e7f1ec54068416ff82bdd09c41a4f
...
public record LayoutDetectionConfig(
    ...
    public static LayoutDetectionConfig fromJson(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse LayoutDetectionConfig from JSON", e);
        }
    }
}
