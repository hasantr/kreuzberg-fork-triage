...
// alef:hash:f855e6492b9d19c1b197c45e088dba08e91e4b96abec419b8fed507fefdacd2b
...
public record ImageExtractionConfig(
    ...
    public static ImageExtractionConfig fromJson(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse ImageExtractionConfig from JSON", e);
        }
    }
