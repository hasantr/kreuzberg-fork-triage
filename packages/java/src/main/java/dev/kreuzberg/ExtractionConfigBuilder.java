...
// alef:hash:fdf1b60f864cb98e35afc01d9f4cd0a071f196cd9d8af16f33309abe1db858d0
...
public class ExtractionConfigBuilder {
    ...
    public ExtractionConfig build() {
        return new ExtractionConfig(useCache, enableQualityProcessing, ocr.orElse(null), forceOcr,
                ...
                layout.orElse(null), useLayoutForMarkdown, includeDocumentStructure, acceleration.orElse(null),
                cacheNamespace.orElse(null), cacheTtlSecs.orElse(null), email.orElse(null), concurrency.orElse(null),
                maxArchiveDepth, treeSitter.orElse(null), structuredExtraction.orElse(null), cancelToken.orElse(null));
    }
}
