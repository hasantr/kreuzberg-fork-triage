...
// alef:hash:004b7584fc01b7c435ee82f7b7b4d5ee0629acd5cfa77042905af375a11a17ca
...
public record ChunkingConfig(@JsonProperty("max_chars") long maxCharacters, @JsonProperty("max_overlap") long overlap,
        boolean trim, @JsonProperty("chunker_type") ChunkerType chunkerType, @Nullable EmbeddingConfig embedding,
