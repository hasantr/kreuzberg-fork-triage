...
// alef:hash:e31dc1a25f822eef8e62242953ad76b8534c640e9ff4d529bd78b51534acfe03
...
class FormatMetadataSerializer extends StdSerializer<FormatMetadata> {
    ...
    public void serialize(FormatMetadata value, JsonGenerator gen, SerializerProvider provider)
        ...
        String tag;
        Object inner;
        if (value instanceof FormatMetadata.Pdf v) {
            tag = "pdf";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Docx v) {
            tag = "docx";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Excel v) {
            tag = "excel";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Email v) {
            tag = "email";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Pptx v) {
            tag = "pptx";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Archive v) {
            tag = "archive";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Image v) {
            tag = "image";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Xml v) {
            tag = "xml";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Text v) {
            tag = "text";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Html v) {
            tag = "html";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Ocr v) {
            tag = "ocr";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Csv v) {
            tag = "csv";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Bibtex v) {
            tag = "bibtex";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Citation v) {
            tag = "citation";
            inner = v.value();
        } else if (value instanceof FormatMetadata.FictionBook v) {
            tag = "fiction_book";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Dbf v) {
            tag = "dbf";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Jats v) {
            tag = "jats";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Epub v) {
            tag = "epub";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Pst v) {
            tag = "pst";
            inner = v.value();
        } else if (value instanceof FormatMetadata.Code v) {
            tag = "code";
            inner = v.value();
        } else {
        ...
        if (inner != null) {
            ...
            if (tree.isObject()) {
                java.util.Iterator<java.util.Map.Entry<String, com.fasterxml.jackson.databind.JsonNode>> it = tree
                        .fields();
                while (it.hasNext()) {
