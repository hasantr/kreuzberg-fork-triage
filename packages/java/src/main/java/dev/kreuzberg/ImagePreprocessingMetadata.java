...
// alef:hash:77de932fb227712838af2bde033170252447a3e6140bfd99050976035e65d4df
...
public record ImagePreprocessingMetadata(
    ...
    public static ImagePreprocessingMetadata fromJson(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse ImagePreprocessingMetadata from JSON", e);
        }
    }
}
