...
// alef:hash:a1598ea7c431261b103508f7e5bd4139cfad83a1bcb188a506d92d362b7ece8c
...
public record ImagePreprocessingMetadata(
    ...
    public static ImagePreprocessingMetadata fromJson(String json) throws KreuzbergRsException {
        try {
            ...
            throw new KreuzbergRsException("Failed to parse ImagePreprocessingMetadata from JSON: " + e.getMessage(),
                    e);
        }
    }
}
