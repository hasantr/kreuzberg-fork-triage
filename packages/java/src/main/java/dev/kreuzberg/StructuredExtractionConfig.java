...
// alef:hash:430ca9aaf67b2458a690d31e7f5c08fbdf4d69d3674fb2419b60fc507d180014
...
public record StructuredExtractionConfig(Object schema, @JsonProperty("schema_name") String schemaName,
    ...
    public static StructuredExtractionConfig fromJson(String json) throws KreuzbergRsException {
        try {
            ...
            throw new KreuzbergRsException("Failed to parse StructuredExtractionConfig from JSON: " + e.getMessage(),
                    e);
        }
    }
}
