...
// alef:hash:6614c6d2c3cb0e75f7621424669ac8956193aab35a0471d930f639bd17f03a57
...
public record ImagePreprocessingConfig(
    ...
    public static ImagePreprocessingConfig fromJson(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse ImagePreprocessingConfig from JSON", e);
        }
    }
