...
// alef:hash:57ebb9ad881632694207f5ec0a526a7febadfd02d94968ac837ed87eb27036c9
...
fn extract_bytes(content: Vec<u8>, mime_type: String, config: magnus::Value) -> Result<ExtractionResult, Error> {
...
fn extract_bytes_async(content: Vec<u8>, mime_type: String, config: magnus::Value) -> Result<ExtractionResult, Error> {
    let config_core: kreuzberg::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
fn extract_file(args: &[magnus::Value]) -> Result<ExtractionResult, Error> {
    let args = magnus::scan_args::scan_args::<((String,), (Option<String>, Option<magnus::Value>))>(args)?;
    ...
    let config_core: kreuzberg::ExtractionConfig = match config {
        Some(_v) if !_v.is_nil() => {
            ...
            serde_json::from_str::<kreuzberg::ExtractionConfig>(&s).map_err(|e| {
                magnus::Error::new(
                    unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
                    e.to_string(),
                )
...
fn extract_bytes_sync(content: Vec<u8>, mime_type: String, config: magnus::Value) -> Result<ExtractionResult, Error> {
    let config_core: kreuzberg::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
fn batch_extract_files_sync(items: Vec<BatchFileItem>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
    let config_core: kreuzberg::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
fn batch_extract_bytes_sync(items: Vec<BatchBytesItem>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
    let config_core: kreuzberg::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
fn batch_extract_files(items: Vec<BatchFileItem>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
    let config_core: kreuzberg::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
fn batch_extract_files_async(items: Vec<BatchFileItem>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
    let config_core: kreuzberg::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
fn batch_extract_bytes(items: Vec<BatchBytesItem>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
    let config_core: kreuzberg::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
fn batch_extract_bytes_async(
    items: Vec<BatchBytesItem>,
    config: magnus::Value,
) -> Result<Vec<ExtractionResult>, Error> {
    let config_core: kreuzberg::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
fn embed_texts(texts: Vec<String>, config: magnus::Value) -> Result<Vec<Vec<f32>>, Error> {
    let config_core: kreuzberg::EmbeddingConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
                unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method(
        "finalize_node_types",
        method!(DocumentStructure::finalize_node_types, 0),
    )?;
    ...
    module.define_module_function("batch_extract_files_sync", function!(batch_extract_files_sync, 2))?;
    module.define_module_function("batch_extract_bytes_sync", function!(batch_extract_bytes_sync, 2))?;
    module.define_module_function("batch_extract_files", function!(batch_extract_files, 2))?;
    module.define_module_function("batch_extract_files_async", function!(batch_extract_files_async, 2))?;
    ...
    module.define_module_function("embed_texts", function!(embed_texts, 2))?;
