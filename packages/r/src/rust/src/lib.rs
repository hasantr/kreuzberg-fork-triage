...
// alef:hash:58a185fe33c8bea5a8017523dd9eb9d5aa146a9ba4a3376bfe098ff0e5deafb9
...
pub fn clear_ocr_backends() -> Result<()> {
    kreuzberg::clear_ocr_backends().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
pub fn clear_post_processors() -> Result<()> {
    kreuzberg::clear_post_processors().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
pub fn clear_validators() -> Result<()> {
    kreuzberg::clear_validators().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
