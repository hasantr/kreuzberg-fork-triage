...
impl ExtractionConfig {
    pub fn needs_image_processing(&self) -> bool {
        ...
        let core_self = kreuzberg::ExtractionConfig {
            ...
            extraction_timeout_secs: self.extraction_timeout_secs as u64,
            max_concurrent_extractions: self.max_concurrent_extractions as usize,
            ...
            cache_ttl_secs: self.cache_ttl_secs as u64,
...
pub fn new_extractionconfig(
    ...
    if let Some(v) = html_options { __out.html_options = Some(v); }
    ...
    if let Some(v) = security_limits { __out.security_limits = Some(v); }
...
pub fn new_drawing(
    ...
    if let Some(v) = extent { __out.extent = Some(v); }
    if let Some(v) = doc_properties { __out.doc_properties = Some(v); }
    if let Some(v) = image_ref { __out.image_ref = Some(v); }
    __out
}
...
pub fn new_anchorproperties(
    ...
    if let Some(v) = relative_height { __out.relative_height = Some(v); }
    if let Some(v) = position_h { __out.position_h = Some(v); }
    if let Some(v) = position_v { __out.position_v = Some(v); }
...
pub fn new_pagemarginspoints(
    ...
    if let Some(v) = top { __out.top = Some(v); }
    if let Some(v) = right { __out.right = Some(v); }
    if let Some(v) = bottom { __out.bottom = Some(v); }
    if let Some(v) = left { __out.left = Some(v); }
    if let Some(v) = header { __out.header = Some(v); }
    if let Some(v) = footer { __out.footer = Some(v); }
    if let Some(v) = gutter { __out.gutter = Some(v); }
    __out
}
...
pub fn new_tableproperties(
    ...
    if let Some(v) = style_id { __out.style_id = Some(v); }
    if let Some(v) = width { __out.width = Some(v); }
    if let Some(v) = alignment { __out.alignment = Some(v); }
    if let Some(v) = layout { __out.layout = Some(v); }
    if let Some(v) = look { __out.look = Some(v); }
    if let Some(v) = borders { __out.borders = Some(v); }
    if let Some(v) = cell_margins { __out.cell_margins = Some(v); }
    if let Some(v) = indent { __out.indent = Some(v); }
    if let Some(v) = caption { __out.caption = Some(v); }
    __out
}
...
pub fn new_odtproperties(
    ...
    if let Some(v) = initial_creator { __out.initial_creator = Some(v); }
    if let Some(v) = keywords { __out.keywords = Some(v); }
    if let Some(v) = description { __out.description = Some(v); }
    if let Some(v) = date { __out.date = Some(v); }
    if let Some(v) = creation_date { __out.creation_date = Some(v); }
    if let Some(v) = language { __out.language = Some(v); }
    if let Some(v) = generator { __out.generator = Some(v); }
    if let Some(v) = editing_duration { __out.editing_duration = Some(v); }
    if let Some(v) = editing_cycles { __out.editing_cycles = Some(v); }
    if let Some(v) = page_count { __out.page_count = Some(v); }
    if let Some(v) = word_count { __out.word_count = Some(v); }
    if let Some(v) = character_count { __out.character_count = Some(v); }
    if let Some(v) = paragraph_count { __out.paragraph_count = Some(v); }
...
impl Metadata {
    pub fn is_empty(&self) -> bool {
        let core_self = kreuzberg::Metadata {
            ...
            sheet_count: self.sheet_count as usize,
...
pub fn new_textmetadata(
    ...
    if let Some(v) = headers { __out.headers = Some(v); }
    if let Some(v) = links { __out.links = Some(v); }
    if let Some(v) = code_blocks { __out.code_blocks = Some(v); }
    __out
}
...
pub fn new_docxmetadata(
    ...
    if let Some(v) = core_properties { __out.core_properties = Some(v); }
    if let Some(v) = app_properties { __out.app_properties = Some(v); }
...
impl From<InlineElement> for kreuzberg::InlineElement {
    fn from(val: InlineElement) -> Self {
        Self {
            ...
            content: val.content,
            attributes: Default::default(),
            metadata: val.metadata.map(|m| m.into_iter().map(|(k, v)| (k.into(), v.into())).collect()),
        }
    }
}
...
impl From<DocumentNode> for kreuzberg::DocumentNode {
    fn from(val: DocumentNode) -> Self {
        Self {
            ...
            children: (val.children.into_iter().map(|v| v as u32).collect()).into_iter().map(kreuzberg::NodeIndex).collect(),
            ...
            attributes: val.attributes.map(|m| m.into_iter().map(|(k, v)| (k.into(), v.into())).collect()),
        }
    }
}
...
impl From<kreuzberg::DocumentNode> for DocumentNode {
    fn from(val: kreuzberg::DocumentNode) -> Self {
        Self {
            ...
            children: val.children.iter().map(|v| v.0).collect::<Vec<_>>().iter().map(|&v| v as i32).collect(),
            content_layer: val.content_layer.into(),
...
impl From<kreuzberg::PptxExtractionResult> for PptxExtractionResult {
    fn from(val: kreuzberg::PptxExtractionResult) -> Self {
        Self {
            ...
            office_metadata: val.office_metadata.into_iter().map(|(k, v)| (k.into(), v.into())).collect(),
        }
    }
}
...
impl From<HtmlMetadata> for kreuzberg::HtmlMetadata {
    fn from(val: HtmlMetadata) -> Self {
        Self {
            ...
            twitter_card: val.twitter_card.into_iter().map(|(k, v)| (k.into(), v.into())).collect(),
...
impl From<JatsMetadata> for kreuzberg::JatsMetadata {
    fn from(val: JatsMetadata) -> Self {
        Self {
            ...
            license: val.license,
            history_dates: val.history_dates.into_iter().map(|(k, v)| (k.into(), v.into())).collect(),
...
#[extendr]
pub fn extract_bytes(content: Vec<u8>, mime_type: String, config: ExtractionConfig) -> Result<ExtractionResult> {
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_file(path: String, mime_type: Option<String>, config: Option<ExtractionConfig>) -> Result<ExtractionResult> {
...
pub fn extract_file_sync(path: String, mime_type: Option<String>, config: Option<ExtractionConfig>) -> Result<ExtractionResult> {
    let config_core: kreuzberg::ExtractionConfig = config.expect("'config' is required").into();
    kreuzberg::extract_file_sync(std::path::PathBuf::from(path), mime_type.as_deref(), &config_core).map(Into::into).map_err(|e| extendr_api::Error::Other(e.to_string()))
}
...
pub fn extract_bytes_sync(content: Vec<u8>, mime_type: String, config: ExtractionConfig) -> Result<ExtractionResult> {
    let config_core: kreuzberg::ExtractionConfig = config.into();
    kreuzberg::extract_bytes_sync(&content, &mime_type, &config_core).map(Into::into).map_err(|e| extendr_api::Error::Other(e.to_string()))
}
...
pub fn batch_extract_files_sync(items: Vec<BatchFileItem>, config: ExtractionConfig) -> Result<Vec<ExtractionResult>> {
    ...
    let config_core: kreuzberg::ExtractionConfig = config.into();
    kreuzberg::batch_extract_files_sync(items_core, &config_core).map(|val| val.into_iter().map(Into::into).collect()).map_err(|e| extendr_api::Error::Other(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_bytes_sync(items: Vec<BatchBytesItem>, config: ExtractionConfig) -> Result<Vec<ExtractionResult>> {
    let items_core: Vec<_> = items.into_iter().map(Into::into).collect();
    let config_core: kreuzberg::ExtractionConfig = config.into();
    kreuzberg::batch_extract_bytes_sync(items_core, &config_core).map(|val| val.into_iter().map(Into::into).collect()).map_err(|e| extendr_api::Error::Other(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_files(items: Vec<BatchFileItem>, config: ExtractionConfig) -> Result<Vec<ExtractionResult>> {
    let items_core: Vec<_> = items.into_iter().map(Into::into).collect();
    let config_core: kreuzberg::ExtractionConfig = config.into();
    let rt = tokio::runtime::Runtime::new()?;
        rt.block_on(async { kreuzberg::batch_extract_files(items_core, &config_core).await.map_err(|e| e.into()) })
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_bytes(items: Vec<BatchBytesItem>, config: ExtractionConfig) -> Result<Vec<ExtractionResult>> {
    let items_core: Vec<_> = items.into_iter().map(Into::into).collect();
    let config_core: kreuzberg::ExtractionConfig = config.into();
    let rt = tokio::runtime::Runtime::new()?;
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn embed_texts_async(texts: Vec<String>, config: EmbeddingConfig) -> Result<Vec<Vec<f64>>> {
    let config_core: kreuzberg::EmbeddingConfig = config.into();
    let rt = tokio::runtime::Runtime::new()?;
        rt.block_on(async { kreuzberg::embed_texts_async(texts, &config_core).await.map_err(|e| e.into()) })
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn render_pdf_page_to_png(pdf_bytes: Vec<u8>, page_index: f64, dpi: Option<i32>, password: Option<String>) -> Result<Vec<u8>> {
    kreuzberg::render_pdf_page_to_png(&pdf_bytes, page_index, dpi, password.as_deref()).map_err(|e| extendr_api::Error::Other(e.to_string()))
}
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn embed_texts(texts: Vec<String>, config: EmbeddingConfig) -> Result<Vec<Vec<f64>>> {
    let config_core: kreuzberg::EmbeddingConfig = config.into();
    kreuzberg::embed_texts(texts, &config_core).map_err(|e| extendr_api::Error::Other(e.to_string()))
}
...
impl kreuzberg::plugins::OcrBackend for ROcrBackendBridge {
    ...
    async fn process_document(&self, _path: &std::path::Path, _config: &kreuzberg::OcrConfig) -> std::result::Result<kreuzberg::ExtractionResult, kreuzberg::KreuzbergError> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let args = extendr_api::Pairlist::from_pairs(&[("path", extendr_api::Robj::from(_path_str.as_str())), ("config", extendr_api::Robj::from(_config_json.as_str()))]);
            let result = fn_robj.call(args);
            match result {
                Err(_) => {
                    Err(kreuzberg::KreuzbergError::Plugin {
...
impl kreuzberg::plugins::PostProcessor for RPostProcessorBridge {
    ...
    fn should_process(&self, _result: &kreuzberg::ExtractionResult, _config: &kreuzberg::ExtractionConfig) -> bool {
        ...
        let args = extendr_api::Pairlist::from_pairs(&[("result", extendr_api::Robj::from(_result)), ("config", extendr_api::Robj::from(_config))]);
        let result = fn_robj.call(args);
        match result {
            Err(_) => {
                Default::default()
    ...
    fn estimated_duration_ms(&self, _result: &kreuzberg::ExtractionResult) -> u64 {
        ...
        let args = extendr_api::Pairlist::from_pairs(&[("result", extendr_api::Robj::from(_result))]);
        let result = fn_robj.call(args);
        match result {
            Err(_) => {
                Default::default()
