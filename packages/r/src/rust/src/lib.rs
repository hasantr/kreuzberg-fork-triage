...
// alef:hash:fd3d6bb2416ca6cd9489430b2a701dfdaeda0cd882ddf294e2adadfb95746fbb
...
pub fn new_extractionconfig(
    ...
    if let Some(v) = security_limits {
        __out.security_limits = Some(v);
    }
...
#[extendr]
pub fn extract_bytes(content: Vec<u8>, mime_type: String, config: &ExtractionConfig) -> Result<Robj> {
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_file(path: String, mime_type: Option<String>, config: &ExtractionConfig) -> Result<Robj> {
    let config_core: kreuzberg::ExtractionConfig = config.clone().into();
    let rt = tokio::runtime::Runtime::new().map_err(|e| extendr_api::Error::Other(e.to_string()))?;
    let result = rt.block_on(async {
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_file_sync(path: String, mime_type: Option<String>, config: &ExtractionConfig) -> Result<Robj> {
    let config_core: kreuzberg::ExtractionConfig = config.clone().into();
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_bytes_sync(content: Vec<u8>, mime_type: String, config: &ExtractionConfig) -> Result<Robj> {
    let config_core: kreuzberg::ExtractionConfig = config.clone().into();
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_files_sync(items: String, config: &ExtractionConfig) -> Result<Robj> {
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_bytes_sync(items: String, config: &ExtractionConfig) -> Result<Robj> {
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_files(items: String, config: &ExtractionConfig) -> Result<Robj> {
    let items_core: Vec<kreuzberg::BatchFileItem> =
        serde_json::from_str(&items).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
    let config_core: kreuzberg::ExtractionConfig = config.clone().into();
    let rt = tokio::runtime::Runtime::new().map_err(|e| extendr_api::Error::Other(e.to_string()))?;
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_bytes(items: String, config: &ExtractionConfig) -> Result<Robj> {
    let items_core: Vec<kreuzberg::BatchBytesItem> =
        serde_json::from_str(&items).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
    let config_core: kreuzberg::ExtractionConfig = config.clone().into();
    let rt = tokio::runtime::Runtime::new().map_err(|e| extendr_api::Error::Other(e.to_string()))?;
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn embed_texts_async(texts: Vec<String>, config: &EmbeddingConfig) -> Result<Robj> {
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn embed_texts(texts: Vec<String>, config: &EmbeddingConfig) -> Result<Robj> {
    let config_core: kreuzberg::EmbeddingConfig = config.clone().into();
