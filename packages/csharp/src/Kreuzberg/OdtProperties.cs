...
// alef:hash:bb383f63f528d667b3e9ed91faaa17fdc6a3f59aa3b0f700d8e486e00f3d2c75
...
public sealed class OdtProperties
{
    ...
    /// <summary>
    /// Parse a <see cref="OdtProperties"/> from a JSON string.
    /// </summary>
    /// <exception cref="KreuzbergException">When the JSON cannot be deserialised.</exception>
    public static OdtProperties FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<OdtProperties>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse OdtProperties from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse OdtProperties from JSON: {e.Message}", e);
        }
    }
