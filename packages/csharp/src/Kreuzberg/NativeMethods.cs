...
// alef:hash:2c6025196ef878910351a4e02df71229e9d7e8ef1f826ca09b5d2281ecada551
#nullable enable
...
internal static partial class NativeMethods
{
    ...
    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_tesseract_wasm_backend_free")]
    internal static extern void TesseractWasmBackendFree(IntPtr ptr);
    ...
    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_tesseract_wasm_backend_name")]
    internal static extern IntPtr TesseractWasmBackendName(
        IntPtr handle
    );

    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_tesseract_wasm_backend_version")]
    internal static extern IntPtr TesseractWasmBackendVersion(
        IntPtr handle
    );

    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_tesseract_wasm_backend_initialize")]
    internal static extern void TesseractWasmBackendInitialize(
        IntPtr handle
    );

    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_tesseract_wasm_backend_shutdown")]
    internal static extern void TesseractWasmBackendShutdown(
        IntPtr handle
    );

    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_tesseract_wasm_backend_process_image")]
    internal static extern IntPtr TesseractWasmBackendProcessImage(
        IntPtr handle,
        IntPtr imageBytes,
    ...
    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_tesseract_wasm_backend_process_image_file")]
    internal static extern IntPtr TesseractWasmBackendProcessImageFile(
        IntPtr handle,
        [MarshalAs(UnmanagedType.LPStr)] string path,
        IntPtr config
    );

    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_tesseract_wasm_backend_supports_language")]
    internal static extern int TesseractWasmBackendSupportsLanguage(
        IntPtr handle,
        [MarshalAs(UnmanagedType.LPStr)] string lang
    );

    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_tesseract_wasm_backend_backend_type")]
    internal static extern IntPtr TesseractWasmBackendBackendType(
        IntPtr handle
    );
