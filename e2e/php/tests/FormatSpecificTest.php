...
// alef:hash:ee1dfcc37b1c5daf24b588aa26f632f1bef66179c5ea396b224e9c6d8ee134ba
...
final class FormatSpecificTest extends TestCase
{
    ...
    {
        $result = Kreuzberg::extractBytesSync(file_get_contents("docx/fake.docx"), "application/vnd.openxmlformats-officedocument.wordprocessingml.document");
    ...
    {
        $result = Kreuzberg::extractBytesSync(file_get_contents("pdf/fake_memo.pdf"), "application/pdf");
