...
// alef:hash:600ed2c1e0692f1a1eb9d3c332340ec5f14eab04638613ab8a42f85dce8ebd27
...
final class SmokeTest extends TestCase
{
    ...
    {        $contentBytes = file_get_contents("images/test_hello_world.png");
        ...
        $result = Kreuzberg::extractBytesAsync($contentBytes, "image/png", $config);
    ...
    {        $config = ExtractionConfig::from_json('{}');
        $result = Kreuzberg::extractFileAsync("docx/fake.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", $config);
    ...
    {        $config = ExtractionConfig::from_json('{}');
        $result = Kreuzberg::extractFileAsync("html/simple_table.html", "text/html", $config);
    ...
    {        $config = ExtractionConfig::from_json('{}');
        $result = Kreuzberg::extractFileAsync("json/simple.json", "application/json", $config);
    ...
    {        $config = ExtractionConfig::from_json('{}');
        $result = Kreuzberg::extractFileAsync("pdf/fake_memo.pdf", "application/pdf", $config);
    ...
    {        $config = ExtractionConfig::from_json('{}');
        $result = Kreuzberg::extractFileAsync("text/report.txt", "text/plain", $config);
    ...
    {        $config = ExtractionConfig::from_json('{}');
        $result = Kreuzberg::extractFileAsync("xlsx/stanley_cups.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", $config);
    ...
    foreach ($result->metadata->format->excel->sheetNames as $item) {
        if (str_contains((string)$item, "Stanley Cups")) { $found = true; }
    }
