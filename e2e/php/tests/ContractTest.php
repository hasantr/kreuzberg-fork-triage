...
// alef:hash:f698f32f54d1465efdc9fdf8b3c9f674d4af3133e55869854f3bb6f144857b22
...
final class ContractTest extends TestCase
{
    ...
    {
        $result = Kreuzberg\Kreuzberg::extractFile_async("pdf/fake_memo.pdf", ["extraction_timeout_secs" => 300]);
        $this->assertEquals("application/pdf", $result->mime_type);
        $this->assertGreaterThanOrEqual(10, strlen($result->content));
    }
    ...
    public function test_config_document_structure(): void
    {
        ...
        $this->assertStringContainsString("paragraph", $result->document->node_types);
    }
