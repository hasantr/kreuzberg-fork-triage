...
# alef:hash:da03b6add942cc9c247bb8a2f99c39d2f7b00d4388599f70aef32bec3dbc5bfd
...
RSpec.describe 'smoke' do
  it 'smoke_cache_namespace: Smoke test: Extraction with cache namespace and TTL configuration' do
    result = Kreuzberg.extract_file('text/report.txt', nil, Kreuzberg::ExtractionConfig.new(cache_namespace: 'test_tenant', cache_ttl_secs: 3600, use_cache: true))
