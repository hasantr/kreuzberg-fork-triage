...
# alef:hash:9393d4e64ac07e7b7caf3ea254da741b02679b9c10de34df8022072e96810e23
...
async def test_office_dbf_basic() -> None:
    ...
    result = await extract_file(path=path)
    assert result.mime_type.strip() == "application/x-dbf"  # noqa: S101
    assert len(result.content) >= 10  # noqa: S101
...
async def test_office_docx_tables() -> None:
    ...
    assert "Nested Table" in result.content  # noqa: S101
    assert "merged cells" in result.content  # noqa: S101
...
async def test_office_mdx_basic() -> None:
    ...
    result = await extract_file(path=path)
    assert any(v in result.mime_type for v in ["text/mdx", "text/x-mdx"])  # noqa: S101
    assert len(result.content) >= 50  # noqa: S101
    assert "MDX Sample Document" in result.content  # noqa: S101
...
async def test_office_mdx_getting_started() -> None:
    ...
    result = await extract_file(path=path)
    assert any(v in result.mime_type for v in ["text/mdx", "text/x-mdx"])  # noqa: S101
    assert len(result.content) >= 2000  # noqa: S101
    assert "Getting started" in result.content  # noqa: S101
    assert "Prerequisites" in result.content  # noqa: S101
    assert "Quick start" in result.content  # noqa: S101
    assert "Bundler" in result.content  # noqa: S101
    assert "Security" in result.content  # noqa: S101
    assert "Integrations" in result.content  # noqa: S101
    assert "esbuild" in result.content  # noqa: S101
    assert "Rollup" in result.content  # noqa: S101
    assert "webpack" in result.content  # noqa: S101
...
async def test_office_mdx_troubleshooting() -> None:
    ...
    assert any(v in result.mime_type for v in ["text/mdx", "text/x-mdx"])  # noqa: S101
    assert len(result.content) >= 2000  # noqa: S101
    assert "Troubleshooting MDX" in result.content  # noqa: S101
    assert "Problems integrating MDX" in result.content  # noqa: S101
    assert "ESM" in result.content  # noqa: S101
...
async def test_office_mdx_using_mdx() -> None:
    ...
    assert any(v in result.mime_type for v in ["text/mdx", "text/x-mdx"])  # noqa: S101
    assert len(result.content) >= 2000  # noqa: S101
    assert "Using MDX" in result.content  # noqa: S101
    assert "How MDX works" in result.content  # noqa: S101
    assert "MDX content" in result.content  # noqa: S101
    assert "Props" in result.content  # noqa: S101
    assert "Components" in result.content  # noqa: S101
    assert "Layout" in result.content  # noqa: S101
...
async def test_office_odt_list() -> None:
    ...
    result = await extract_file(path=path)
    assert result.mime_type.strip() == "application/vnd.oasis.opendocument.text"  # noqa: S101
    assert len(result.content) >= 30  # noqa: S101
...
async def test_office_xlsx_basic() -> None:
    ...
    assert result.metadata.sheet_names is not None  # noqa: S101
    assert any("Stanley Cups" in text for item in result.metadata.sheet_names for text in _alef_e2e_item_texts(item))  # noqa: S101
