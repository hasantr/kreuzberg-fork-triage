...
# alef:hash:deb0be80b1a3c4587cd904d097bdefd66666dd91289b5dfd06bb673633a6bd52
# To regenerate: alef generate
# To verify freshness: alef verify --exit-code
# Issues & docs: https://github.com/kreuzberg-dev/alef
"""E2e tests for category: contract."""
import pytest  # noqa: F401
from kreuzberg import batch_extract_bytes, batch_extract_bytes_sync, extract_file, extract_bytes, extract_bytes_sync, extract_file_sync, ExtractionConfig
...
def test_config_chunking_heading_context() -> None:
    ...
    config = ExtractionConfig(chunking={"chunker_type": "markdown", "max_chars": 300, "max_overlap": 50})
    result = extract_file_sync(path=path, config=config)
    assert len(result.content) >= 10  # noqa: S101
...
def test_config_chunking_markdown() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(chunking={"chunker_type": "markdown", "max_chars": 500, "max_overlap": 50})
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert len(result.content) >= 10  # noqa: S101
    assert len(result.chunks) >= 1  # noqa: S101
...
def test_config_chunking_semantic_threshold() -> None:
    ...
    config = ExtractionConfig(chunking={"chunker_type": "semantic", "topic_threshold": 0.5})
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "text/plain"  # noqa: S101
    assert len(result.content) >= 100  # noqa: S101

@pytest.mark.skip(reason="Semantic chunking with a plugin embedder requires the plugin to be registered at runtime via register_embedding_backend — the e2e harness cannot do this. Covers config round-trip only.")
def test_config_chunking_semantic_with_plugin() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(chunking={"chunker_type": "semantic", "embedding": {"max_embed_duration_secs": 60, "model": {"name": "test-semantic-plugin", "type": "plugin"}, "normalize": True}, "max_chars": 1024, "max_overlap": 100, "topic_threshold": 0.75})
...
def test_config_chunking_text() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(chunking={"chunker_type": "text", "max_chars": 500, "max_overlap": 50})
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert len(result.content) >= 10  # noqa: S101
    assert len(result.chunks) >= 1  # noqa: S101
...
def test_config_chunking_tokenizer() -> None:
    ...
    config = ExtractionConfig(chunking={"max_chars": 200, "max_overlap": 40, "sizing": {"model": "Xenova/gpt-4o", "type": "tokenizer"}})
    result = extract_file_sync(path=path, config=config)
    assert len(result.content) >= 10  # noqa: S101
    assert len(result.chunks) >= 2  # noqa: S101
    assert all(c.content for c in (result.chunks or []))  # noqa: S101
...
def test_config_document_structure() -> None:
    ...
    assert any("paragraph" in text for item in result.document.node_types for text in _alef_e2e_item_texts(item))  # noqa: S101
...
def test_config_document_structure_groups() -> None:
    ...
    assert result.document  # noqa: S101
    assert any(any(v in text for text in _alef_e2e_item_texts(item)) for item in result.document.node_types for v in ["group"])  # noqa: S101
...
def test_config_document_structure_headings() -> None:
    ...
    assert result.document  # noqa: S101
    assert len(result.document.nodes) >= 1  # noqa: S101
    assert any("heading" in text for item in result.document.node_types for text in _alef_e2e_item_texts(item))  # noqa: S101
    assert any("paragraph" in text for item in result.document.node_types for text in _alef_e2e_item_texts(item))  # noqa: S101
...
def test_config_force_ocr_pages() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(force_ocr_pages=[1], ocr={"backend": "tesseract", "language": "eng"})
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
...
def test_config_html_styled_custom_css() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(html_output={"css": ".kb-p { color: red; }", "embed_css": True, "theme": "unstyled"}, output_format="html")
    result = extract_file_sync(path=path, config=config)
...
def test_config_html_styled_default() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(html_output={"embed_css": True, "theme": "default"}, output_format="html")
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert result.metadata.output_format.strip() == "html"  # noqa: S101
    assert "kb-doc" in result.content  # noqa: S101
...
def test_config_html_styled_no_embed() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(html_output={"embed_css": False, "theme": "default"}, output_format="html")
    result = extract_file_sync(path=path, config=config)
    assert result.metadata.output_format.strip() == "html"  # noqa: S101
    assert "kb-doc" in result.content  # noqa: S101
    assert "kb-content" in result.content  # noqa: S101
...
def test_config_language_detection() -> None:
    ...
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert len(result.content) >= 10  # noqa: S101
    assert result.detected_languages is not None  # noqa: S101
    assert any("eng" in text for item in result.detected_languages for text in _alef_e2e_item_texts(item))  # noqa: S101
...
def test_config_language_multi() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(language_detection={"detect_multiple": True, "enabled": True})
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert len(result.content) >= 10  # noqa: S101
    assert result.detected_languages is not None  # noqa: S101
...
def test_config_llm_embeddings() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(chunking={"embedding": {"model": {"llm": {"model": "openai/text-embedding-3-small"}, "type": "llm"}, "normalize": True}, "max_chars": 500, "max_overlap": 50})
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert len(result.content) >= 10  # noqa: S101
    assert len(result.chunks) >= 1  # noqa: S101
...
def test_config_llm_structured_extraction_with_prompt() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(structured_extraction={"llm": {"model": "openai/gpt-4o"}, "prompt": "Extract the sender and recipient from this memo document. If not found, use 'unknown'.", "schema": {"properties": {"recipient": {"type": "string"}, "sender": {"type": "string"}, "subject": {"type": "string"}}, "required": ["sender", "recipient"], "type": "object"}, "schema_name": "memo_parties"})
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert len(result.content) >= 10  # noqa: S101
    assert result.structured_output  # noqa: S101
...
def test_config_llm_vlm_ocr() -> None:
    ...
    path = "images/test_hello_world.png"
    config = ExtractionConfig(ocr={"backend": "vlm", "language": "eng", "vlm_config": {"model": "openai/gpt-4o"}})
    result = extract_file_sync(path=path, config=config)
    assert result.content  # noqa: S101
    assert len(result.content) >= 5  # noqa: S101
...
def test_config_pdf_hierarchy() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(pages={"extract_pages": True}, pdf_options={"hierarchy": {"enabled": True, "include_bbox": True}})
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert len(result.content) >= 50  # noqa: S101
...
def test_config_pdf_margins() -> None:
    ...
    path = "pdf/fake_memo.pdf"
    config = ExtractionConfig(pdf_options={"bottom_margin_fraction": 0.1, "top_margin_fraction": 0.1})
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert len(result.content) >= 5  # noqa: S101
...
def test_config_structured_output() -> None:
    ...
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert len(result.content) >= 10  # noqa: S101
    assert result.metadata.output_format.strip() == "structured"  # noqa: S101
...
def test_config_tree_sitter_process() -> None:
    ...
    path = "code/hello.py"
    config = ExtractionConfig(tree_sitter={"process": {"chunk_max_size": 2000, "comments": True, "diagnostics": True, "docstrings": True, "exports": True, "imports": True, "structure": True, "symbols": True}})
    result = extract_file_sync(path=path, config=config)
    assert result.mime_type.strip() == "text/x-source-code"  # noqa: S101
    assert len(result.content) >= 5  # noqa: S101
...
def test_result_format_unified() -> None:
    ...
    assert result.mime_type.strip() == "application/pdf"  # noqa: S101
    assert len(result.content) >= 10  # noqa: S101
    assert not result.elements  # noqa: S101
