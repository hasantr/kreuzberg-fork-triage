...
| Name        | Type        | Required | Description    |
| ----------- | ----------- | -------- | -------------- |
| `pdfBytes`  | `Uint8List` | Yes      | The pdf bytes  |
...
| `pageWidthPts`   | `double`       | —       | Page width pts                                                   |
| `pageHeightPts`  | `double`       | —       | Page height pts                                                  |
...
| `data`             | `Uint8List`    | —       | The decoded image bytes in a standard format (JPEG, PNG, etc.).                              |
