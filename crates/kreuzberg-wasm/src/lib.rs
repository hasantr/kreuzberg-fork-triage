...
// alef:hash:e2bf9bc588f0df69b00a726155a7db745d6a18ae1b681cd2bb7da18f88a1636e
...
#[derive(Clone)]
#[wasm_bindgen]
pub struct WasmHwpxExtractor {
    pub(crate) inner: Arc<kreuzberg::extractors::HwpxExtractor>,
}

#[wasm_bindgen]
impl WasmHwpxExtractor {
    #[allow(clippy::should_implement_trait)]
    #[wasm_bindgen]
    pub fn default() -> WasmHwpxExtractor {
        Self {
            inner: Arc::new(kreuzberg::HwpxExtractor::default()),
        }
    }
