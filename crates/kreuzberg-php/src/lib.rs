...
// alef:hash:c17ad96b7ac9451bda959ceadebb8c058c2d0a472811a0df189e1798b77ffc96
...
impl ExtractionConfig {
    ...
    pub fn new(
        ...
        Self {
            ...
            use_layout_for_markdown: Default::default(),
    ...
    #[php(getter)]
    pub fn get_contentFilter(&self) -> Option<ContentFilterConfig> {
    ...
    #[php(getter)]
    pub fn get_pdfOptions(&self) -> Option<PdfConfig> {
        self.pdf_options.clone()
    }

    #[php(getter)]
    pub fn get_tokenReduction(&self) -> Option<TokenReductionOptions> {
        self.token_reduction.clone()
    }

    #[php(getter)]
    pub fn get_languageDetection(&self) -> Option<LanguageDetectionConfig> {
    ...
    #[php(getter)]
    pub fn get_htmlOutput(&self) -> Option<HtmlOutputConfig> {
        self.html_output.clone()
    }

    #[php(getter)]
    pub fn get_securityLimits(&self) -> Option<SecurityLimits> {
    ...
    #[php(getter)]
    pub fn get_treeSitter(&self) -> Option<TreeSitterConfig> {
        self.tree_sitter.clone()
    }

    #[php(getter)]
    pub fn get_structuredExtraction(&self) -> Option<StructuredExtractionConfig> {
...
impl OcrPipelineStage {
    ...
    #[php(getter)]
    pub fn get_tesseractConfig(&self) -> Option<TesseractConfig> {
        self.tesseract_config.clone()
    }

    #[php(getter)]
    pub fn get_paddleOcrConfig(&self) -> Option<String> {
    ...
    #[php(getter)]
    pub fn get_vlmConfig(&self) -> Option<LlmConfig> {
...
impl OcrPipelineConfig {
    ...
    #[php(getter)]
    pub fn get_qualityThresholds(&self) -> OcrQualityThresholds {
...
impl OcrConfig {
    ...
    #[php(getter)]
    pub fn get_elementConfig(&self) -> Option<OcrElementConfig> {
        self.element_config.clone()
    }

    #[php(getter)]
    pub fn get_qualityThresholds(&self) -> Option<OcrQualityThresholds> {
        self.quality_thresholds.clone()
    }
    ...
    #[php(getter)]
    pub fn get_tessdataBytes(&self) -> Option<HashMap<String, Vec<u8>>> {
...
impl HwpImage {
    ...
    #[php(constructor)]
    pub fn new(name: String, data: PhpBytes) -> Self {
        Self { name, data: data.0 }
    }
...
impl ImageOcrResult {
    ...
    #[php(getter)]
    pub fn get_pageContents(&self) -> Option<Vec<PageContent>> {
...
impl HtmlExtractionResult {
    ...
    #[php(constructor)]
    pub fn new(markdown: String, warnings: Vec<String>) -> Self {
        Self {
            markdown,
            images: Default::default(),
            warnings,
...
pub struct AnchorProperties {
    #[php(prop, name = "behindDoc")]
    pub behind_doc: bool,
    #[php(prop, name = "layoutInCell")]
    pub layout_in_cell: bool,
    #[php(prop, name = "relativeHeight")]
    pub relative_height: Option<i64>,
    #[php(prop, name = "positionH")]
    #[serde(skip)]
    pub position_h: Option<String>,
    #[php(prop, name = "positionV")]
    #[serde(skip)]
    pub position_v: Option<String>,
    #[php(prop, name = "wrapType")]
    #[serde(skip)]
...
impl AnchorProperties {
    ...
    pub fn new(
        behindDoc: bool,
        layoutInCell: bool,
        relativeHeight: Option<i64>,
        positionH: Option<String>,
        positionV: Option<String>,
        wrapType: String,
    ) -> Self {
        Self {
            behind_doc: behindDoc,
...
impl ResolvedStyle {
    ...
    #[php(constructor)]
    pub fn new(paragraphProperties: String, runProperties: String) -> Self {
        Self {
            paragraph_properties: paragraphProperties,
            run_properties: runProperties,
        }
...
#[derive(Clone)]
#[php_class]
#[php(name = "Kreuzberg\\HwpxExtractor")]
...
impl HwpxExtractor {
    ...
    #[php(name = "initialize")]
    pub fn initialize_plugin(&self) -> PhpResult<()> {
        self.inner
            .initialize()
    ...
    #[allow(clippy::should_implement_trait)]
    pub fn default() -> HwpxExtractor {
        Self {
            inner: Arc::new(kreuzberg::extractors::HwpxExtractor::default()),
        }
    }
}
...
impl TokenReductionConfig {
    ...
    #[php(getter)]
    pub fn get_customStopwords(&self) -> Option<HashMap<String, Vec<String>>> {
...
impl PdfAnnotation {
    #[php(constructor)]
    pub fn new(annotationType: String, content: Option<String>, pageNumber: i64, boundingBox: Option<String>) -> Self {
        Self {
...
impl FormattedBlock {
    ...
    #[php(getter)]
    pub fn get_inlineContent(&self) -> Vec<InlineElement> {
...
pub struct ExtractionResult {
    ...
    #[php(prop, name = "codeIntelligence")]
    #[serde(skip)]
...
impl ExtractionResult {
    ...
    #[php(getter)]
    pub fn get_djotContent(&self) -> Option<DjotContent> {
        self.djot_content.clone()
    }

    #[php(getter)]
    pub fn get_ocrElements(&self) -> Option<Vec<OcrElement>> {
    ...
    #[php(getter)]
    pub fn get_structuredOutput(&self) -> Option<String> {
...
impl ChunkMetadata {
    ...
    #[php(getter)]
    pub fn get_headingContext(&self) -> Option<HeadingContext> {
...
impl ExtractedImage {
    ...
    #[php(getter)]
    pub fn get_ocrResult(&self) -> Option<ExtractionResult> {
...
impl ExcelSheet {
    ...
    #[php(getter)]
    pub fn get_tableCells(&self) -> Option<Vec<Vec<String>>> {
...
impl PptxExtractionResult {
    ...
    #[php(getter)]
    pub fn get_pageStructure(&self) -> Option<PageStructure> {
    ...
    #[php(getter)]
    pub fn get_officeMetadata(&self) -> HashMap<String, String> {
...
impl OcrTable {
    ...
    #[php(constructor)]
    pub fn new(cells: Vec<Vec<String>>, markdown: String, pageNumber: i64) -> Self {
        Self {
            cells,
            markdown,
            page_number: pageNumber,
    ...
    #[php(getter)]
    pub fn get_boundingBox(&self) -> Option<OcrTableBoundingBox> {
...
impl Metadata {
    ...
    #[php(getter)]
    pub fn get_imagePreprocessing(&self) -> Option<ImagePreprocessingMetadata> {
        self.image_preprocessing.clone()
    }

    #[php(getter)]
    pub fn get_jsonSchema(&self) -> Option<String> {
...
impl XmlMetadata {
    ...
    #[php(constructor)]
    pub fn new(elementCount: i64, uniqueElements: Vec<String>) -> Self {
        Self {
            element_count: elementCount,
            unique_elements: uniqueElements,
        }
...
impl OcrMetadata {
    ...
    pub fn new(
        ...
        outputFormat: String,
        tableCount: i64,
        tableRows: Option<i64>,
        tableCols: Option<i64>,
    ) -> Self {
        Self {
            language,
            psm,
...
impl PptxMetadata {
    ...
    #[php(constructor)]
    pub fn new(slideCount: i64, slideNames: Vec<String>, imageCount: Option<i64>, tableCount: Option<i64>) -> Self {
        Self {
            slide_count: slideCount,
...
impl DocxMetadata {
    ...
    #[php(getter)]
    pub fn get_coreProperties(&self) -> Option<CoreProperties> {
        self.core_properties.clone()
    }

    #[php(getter)]
    pub fn get_appProperties(&self) -> Option<DocxAppProperties> {
        self.app_properties.clone()
    }

    #[php(getter)]
    pub fn get_customProperties(&self) -> Option<String> {
...
impl BibtexMetadata {
    ...
    #[php(getter)]
    pub fn get_yearRange(&self) -> Option<YearRange> {
        self.year_range.clone()
    }

    #[php(getter)]
    pub fn get_entryTypes(&self) -> Option<HashMap<String, i64>> {
...
impl JatsMetadata {
    ...
    #[php(getter)]
    pub fn get_historyDates(&self) -> HashMap<String, String> {
        self.history_dates.clone()
    }

    #[php(getter)]
    pub fn get_contributorRoles(&self) -> Vec<ContributorRole> {
...
impl OcrElement {
    ...
    #[php(constructor)]
    pub fn new(text: String, level: String, pageNumber: i64, parentId: Option<String>) -> Self {
        Self {
            text,
    ...
    #[php(getter)]
    pub fn get_backendMetadata(&self) -> Option<String> {
...
impl PageStructure {
    ...
    #[php(constructor)]
    pub fn new(totalCount: i64, unitType: String) -> Self {
        Self {
...
impl PageBoundary {
    #[php(constructor)]
    pub fn new(byteStart: i64, byteEnd: i64, pageNumber: i64) -> Self {
        Self {
            byte_start: byteStart,
            byte_end: byteEnd,
            page_number: pageNumber,
...
impl PageInfo {
    ...
    pub fn new(
        ...
        imageCount: Option<i64>,
        tableCount: Option<i64>,
        hidden: Option<bool>,
        isBlank: Option<bool>,
...
impl PageContent {
    ...
    #[php(constructor)]
    pub fn new(pageNumber: i64, content: String, isBlank: Option<bool>) -> Self {
        Self {
            page_number: pageNumber,
            content,
            tables: Default::default(),
    ...
    #[php(getter)]
    pub fn get_layoutRegions(&self) -> Option<Vec<LayoutRegion>> {
...
impl LayoutRegion {
    ...
    #[php(constructor)]
    pub fn new(className: String, confidence: f64, boundingBox: String, areaFraction: f64) -> Self {
        Self {
...
impl PageHierarchy {
    ...
    #[php(constructor)]
    pub fn new(blockCount: i64) -> Self {
        Self {
...
impl Table {
    ...
    #[php(constructor)]
    pub fn new(cells: Vec<Vec<String>>, markdown: String, pageNumber: i64, boundingBox: Option<String>) -> Self {
        Self {
            cells,
            markdown,
            page_number: pageNumber,
...
impl TableCell {
    ...
    #[php(constructor)]
    pub fn new(content: String, rowSpan: i64, colSpan: i64, isHeader: bool) -> Self {
        Self {
            content,
            row_span: rowSpan,
            col_span: colSpan,
...
impl InfoResponse {
    #[php(constructor)]
    pub fn new(version: String, rustBackend: bool) -> Self {
        Self {
            version,
...
impl EmbedResponse {
    ...
    #[php(constructor)]
    pub fn new(embeddings: Vec<Vec<f32>>, model: String, dimensions: i64, count: i64) -> Self {
        Self {
            embeddings,
            model,
            dimensions,
...
impl ChunkRequest {
    #[php(constructor)]
    pub fn new(text: String, config: Option<String>, chunkerType: String) -> Self {
        Self {
            text,
            config,
            chunker_type: chunkerType,
...
impl ChunkResponse {
    #[php(constructor)]
    pub fn new(chunks: Vec<String>, chunkCount: i64, config: String, inputSizeBytes: i64, chunkerType: String) -> Self {
        Self {
            chunks,
...
impl ManifestEntryResponse {
    #[php(constructor)]
    pub fn new(relativePath: String, sha256: String, sizeBytes: i64, sourceUrl: String) -> Self {
        Self {
...
impl ManifestResponse {
    ...
    #[php(constructor)]
    pub fn new(kreuzbergVersion: String, totalSizeBytes: i64, modelCount: i64) -> Self {
        Self {
            kreuzberg_version: kreuzbergVersion,
...
impl WarmResponse {
    #[php(constructor)]
    pub fn new(cacheDir: String, downloaded: Vec<String>, alreadyCached: Vec<String>) -> Self {
        Self {
            cache_dir: cacheDir,
            downloaded,
...
impl StructuredExtractionResponse {
    ...
    #[php(getter)]
    pub fn get_structuredOutput(&self) -> Option<String> {
        serde_json::to_string(&self.structured_output).ok()
    }
}
...
impl OpenWebDocumentResponse {
    #[php(constructor)]
    pub fn new(pageContent: String, metadata: String) -> Self {
        Self {
...
impl DetectMimeTypeParams {
    #[php(constructor)]
    pub fn new(path: String, useContent: bool) -> Self {
        Self {
            path,
...
impl CacheWarmParams {
    #[php(constructor)]
    pub fn new(allEmbeddings: bool, embeddingModel: Option<String>) -> Self {
        Self {
...
impl EmbedTextParams {
    ...
    pub fn new(
        ...
        Self {
            ...
            model,
            api_key: apiKey,
            embedding_plugin: embeddingPlugin,
        }
    }
}
...
impl ChunkTextParams {
    ...
    pub fn new(
        text: String,
        maxCharacters: Option<i64>,
        overlap: Option<i64>,
        chunkerType: Option<String>,
        topicThreshold: Option<f32>,
    ) -> Self {
        Self {
            text,
...
impl DetectedBoundary {
    #[php(constructor)]
    pub fn new(byteOffset: i64, isHeader: bool) -> Self {
        Self {
...
impl MergedChunk {
    #[php(constructor)]
    pub fn new(text: String, byteStart: i64, byteEnd: i64) -> Self {
        Self {
            text,
            byte_start: byteStart,
            byte_end: byteEnd,
...
impl KeywordConfig {
    ...
    #[php(getter)]
    pub fn get_yakeParams(&self) -> Option<YakeParams> {
        self.yake_params.clone()
    }

    #[php(getter)]
    pub fn get_rakeParams(&self) -> Option<RakeParams> {
...
impl RecognizedTable {
    ...
    #[php(getter)]
    pub fn get_detectionBbox(&self) -> BBox {
...
#[async_trait::async_trait]
impl kreuzberg::plugins::DocumentExtractor for PhpDocumentExtractorBridge {
    async fn extract_bytes(
        ...
        WORKER_RUNTIME.block_on(async {
            match unsafe {
                ...
                Err(e) => Err(kreuzberg::KreuzbergError::Plugin {
                    message: format!("Plugin '{}' method 'extract_bytes' failed: {}", cached_name, e),
                    plugin_name: cached_name.clone(),
                }),
            }
        })
...
impl kreuzberg::plugins::Renderer for PhpRendererBridge {
    fn render(
        &self,
