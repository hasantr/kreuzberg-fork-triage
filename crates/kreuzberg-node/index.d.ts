...
// alef:hash:d711a1d6a5731d1ada76104f598df20b2174eafa429302b3003f2b8c3e06aa24
...
export interface JsDocumentExtractor {
   ...
   */
  extractBytes?(content: Uint8Array, mimeType: string, config: JsExtractionConfig): Promise<JsInternalDocument>
  /**
   * Extract content from a file.
   *
   ...
   */
  extractFile?(path: string, mimeType: string, config: JsExtractionConfig): Promise<JsInternalDocument>
  /**
...
export type JsFormatMetadata =
  | { format_type: 'pdf'; 0: JsPdfMetadata }
  ...
  | { format_type: 'image'; 0: JsImageMetadata }
 ...
 */
export declare class JsHwpxExtractor {
  static default(): JsHwpxExtractor
  name(): string
  version(): string
  initialize(): void
  shutdown(): void
...
export interface JsOcrConfig {
   ...
   * at runtime.
   */
  tessdataBytes?: Record<string, Uint8Array>
}
...
export interface JsRenderer {
   ...
   */
  render?(doc: JsInternalDocument): string
}
...
export interface JsSyncExtractor {
   ...
   * @returns An `InternalDocument` containing the extracted elements, metadata, and tables.
   */
  extractSync?(content: Uint8Array, mimeType: string, config: JsExtractionConfig): JsInternalDocument
}
