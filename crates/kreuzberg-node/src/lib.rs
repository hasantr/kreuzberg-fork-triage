...
// alef:hash:0c0c8b44883407ec86fb1bbe4bed1e686842f140d91b6114d6f4a7c4e34ff7c6
...
#[derive(Clone)]
#[napi]
pub struct JsTesseractWasmBackend {
    inner: Arc<kreuzberg::ocr::TesseractWasmBackend>,
}

#[napi]
impl JsTesseractWasmBackend {
    #[napi]
    ...
    pub async fn process_image(
        ...
        let result = inner
            .process_image(&image_bytes, _config.into())
            .await
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        Ok(result.into())
    }
...
impl From<JsOcrBackendType> for kreuzberg::plugins::OcrBackendType {
    fn from(val: JsOcrBackendType) -> Self {
        match val {
            JsOcrBackendType::Tesseract => Self::Tesseract,
            JsOcrBackendType::EasyOCR => Self::EasyOCR,
            JsOcrBackendType::PaddleOCR => Self::PaddleOCR,
            JsOcrBackendType::Custom => Self::Custom,
        }
    }
}
