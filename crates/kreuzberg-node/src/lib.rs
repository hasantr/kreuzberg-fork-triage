...
// alef:hash:2c225a9d30e8e6dd82ff975600335a08e8789b6500614b7a5359f2a5b3ce4a90
...
#[derive(Clone)]
#[napi]
pub struct JsHwpxExtractor {
    inner: Arc<kreuzberg::extractors::HwpxExtractor>,
}

#[napi]
impl JsHwpxExtractor {
    #[napi]
    ...
    #[napi]
    pub fn default() -> JsHwpxExtractor {
        Self {
...
#[async_trait::async_trait]
impl kreuzberg::plugins::DocumentExtractor for JsDocumentExtractorBridge {
...
impl kreuzberg::plugins::Renderer for JsRendererBridge {
    fn render(
        &self,
...
impl From<JsPdfMetadata> for kreuzberg::pdf::metadata::PdfMetadata {
    fn from(val: JsPdfMetadata) -> Self {
        ...
        __result.page_count = val.page_count.map(|v| v as usize);
        __result
    }
}
...
impl From<JsFormatMetadata> for kreuzberg::FormatMetadata {
    fn from(val: JsFormatMetadata) -> Self {
        match val.format_type_tag.as_str() {
            "pdf" => Self::Pdf(
                val._0
                    .and_then(|s| serde_json::from_str::<kreuzberg::PdfMetadata>(&s).ok())
                    .unwrap_or_default(),
            ),
            ...
            "image" => Self::Image(
                val._0
                    .and_then(|s| serde_json::from_str::<kreuzberg::ImageMetadata>(&s).ok())
                    .unwrap_or_default(),
            ),
            "xml" => Self::Xml(
                val._0
