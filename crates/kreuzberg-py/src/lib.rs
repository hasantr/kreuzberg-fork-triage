...
// alef:hash:aac1ecfefd411327af8634a8ba61dc17967587e3fb61ca9ae01961aa2223a5e5
...
impl OcrConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enabled=None, backend=None, language=None, auto_rotate=None, tesseract_config=None, output_format=None, paddle_ocr_config=None, element_config=None, quality_thresholds=None, pipeline=None, vlm_config=None, vlm_prompt=None, acceleration=None, tessdata_bytes=None))]
    #[new]
    pub fn new(
        enabled: Option<bool>,
...
impl PdfConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (extract_images=None, extract_tables=None, extract_metadata=None, extract_annotations=None, allow_single_column_tables=None, passwords=None, hierarchy=None, top_margin_fraction=None, bottom_margin_fraction=None))]
    #[new]
    pub fn new(
        extract_images: Option<bool>,
...
impl HwpxExtractor {
    ...
    pub fn name(&self) -> String {
        String::from("[unimplemented: HwpxExtractor.name]")
    }

    #[pyo3(signature = ())]
    pub fn version(&self) -> String {
        String::from("[unimplemented: HwpxExtractor.version]")
    }
    ...
    pub fn initialize(&self) -> PyResult<()> {
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
            "Not implemented: HwpxExtractor.initialize",
        ))
    }
    ...
    pub fn shutdown(&self) -> PyResult<()> {
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
            "Not implemented: HwpxExtractor.shutdown",
        ))
    }

    #[pyo3(signature = ())]
    pub fn description(&self) -> String {
        String::from("[unimplemented: HwpxExtractor.description]")
    }

    #[pyo3(signature = ())]
    pub fn author(&self) -> String {
        String::from("[unimplemented: HwpxExtractor.author]")
    }
...
impl KeywordConfig {
    #[must_use]
    #[pyo3(signature = (algorithm=None, max_keywords=None, min_score=None, ngram_range=None, language=None))]
    #[new]
    pub fn new(
    ...
    fn render(
        ...
        Python::attach(|py| {
            self.inner
                ...
                .and_then(|v| v.extract::<String>())
                .map_err(|e| kreuzberg::KreuzbergError::Plugin {
                    message: format!("Plugin '{}' method 'render' failed: {}", self.cached_name, e),
                    plugin_name: self.cached_name.clone(),
                })
        })
    }
